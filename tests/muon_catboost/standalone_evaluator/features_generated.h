...
inline const char *EnumNameENanValueTreatment(ENanValueTreatment e) {
  if (e < ENanValueTreatment_AsIs || e > ENanValueTreatment_AsTrue) return "";
...
inline flatbuffers::Offset<TFeatureCombination> CreateTFeatureCombinationDirect(
  ...
  auto FloatSplits__ = FloatSplits ? _fbb.CreateVectorOfStructs<TFloatSplit>(*FloatSplits) : 0;
  auto OneHotSplits__ = OneHotSplits ? _fbb.CreateVectorOfStructs<TOneHotSplit>(*OneHotSplits) : 0;
