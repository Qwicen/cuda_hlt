...
Here are some example run options:
    ...
    ./cu_hlt -f ../input/minbias/velopix_raw -u ../input/minbias/ut_raw -e ../input/minbias/ut_hits -d ../input/minbias/MC_info -g ../input/geometry/
    ...
    ./cu_hlt -f ../input/minbias/velopix_raw -u ../input/minbias/ut_raw -e ../input/minbias/ut_hits -g ../input/geometry/ -n 1000
    ...
    ./cu_hlt -f ../input/minbias/velopix_raw -u ../input/minbias/ut_raw -e ../input/minbias/ut_hits -g ../input/geometry/ -n 3500 -t 12 -r 40
    ...
    ./cu_hlt -f ../input/minbias/velopix_raw -u ../input/minbias/ut_raw -d ../input/minbias/MC_info -e ../input/minbias/ut_hits -g ../input/geometry/ -n 10 -t 1 -r 1 -c 1
    
    # Run one stream and print all memory allocations
    ./cu_hlt -f ../input/minbias/velopix_raw -u ../input/minbias/ut_raw -e ../input/minbias/ut_hits -g ../input/geometry -n 5000 -t 1 -r 1 -p
