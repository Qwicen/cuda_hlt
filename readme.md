...
Here are some example run options:
    ...
    ./cu_hlt -f ../input/minbias/velopix_raw -d ../input/minbias/MC_info -g ../input/geometry
    ...
    ./cu_hlt -f ../input/minbias/velopix_raw -g ../input/geometry -n 1000

    # Run four streams, each with 4000 events, 20 repetitions
    ./cu_hlt -f ../input/minbias/velopix_raw -g ../input/geometry -t 4 -n 4000 -r 20

    # Run twelve streams, each with 3500 events, 40 repetitions
    ./cu_hlt -f ../input/minbias/velopix_raw -g ../input/geometry -n 3500 -t 12 -r 40
    ...
    ./cu_hlt -f ../input/minbias/velopix_raw -g ../input/geometry -n 5000 -t 1 -r 1 -p
