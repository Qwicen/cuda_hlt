...
template<typename T>
__device__ int binary_search_first_candidate(const T* array, const uint array_size, const T& value, const float margin)
{
  bool found = false;
  int l = 0;
  int r = array_size - 1;
...
template<typename T>
__device__ int binary_search_second_candidate(const T* array, const uint array_size, const T& value, const float margin)
{
  int l = 0;
  int r = array_size - 1;
  while (l < r) {
