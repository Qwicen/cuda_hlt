...
namespace ParKalmanFilter {
  ...
  __device__ __host__ void tensorProduct(const Vector<5> &u,
                                         const Vector<5> &v,
  ...
  __device__ __host__ void multiply_S5x5_2x1(const SquareMatrix<true,5> &A,
                                             const Vector<2> &B,
                                             Vector<5> &V){
    /*
  ...
  __device__ __host__ SquareMatrix<true,5> similarity_5_5_alt(const SquareMatrix<false,5> &F,
  ...
  __host__ __device__ void WeightedAverage(
    const Vector<5> &x1, const SquareMatrix<true,5> &C1,
