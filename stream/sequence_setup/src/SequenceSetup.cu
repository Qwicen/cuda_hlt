...
std::array<std::string, std::tuple_size<argument_tuple_t>::value> get_argument_names() {
  ...
  a[arg::dev_windows_layers] = "dev_windows_layers";
...
std::vector<std::vector<int>> get_sequence_dependencies() {
  ...
  sequence_dependencies[tuple_contains<ut_search_windows_t, sequence_t>::index] = {
    arg::dev_ut_hits,
    arg::dev_ut_hit_offsets,
    arg::dev_atomics_storage,
    arg::dev_velo_track_hit_number,
  ...
  sequence_dependencies[tuple_contains<compass_ut_t, sequence_t>::index] = {
    arg::dev_ut_hits,
    arg::dev_ut_hit_offsets,
    arg::dev_atomics_storage,
    arg::dev_velo_track_hit_number,
