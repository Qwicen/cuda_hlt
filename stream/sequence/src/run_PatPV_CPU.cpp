...
int total_number_seed = 0;
for(int i_event = 0; i_event < number_of_events; i_event++)   total_number_seed += number_of_seeds[i_event];

 std::cout << "total nubmer seeds in all events: " << total_number_seed << std::endl;
  return 0;
}
