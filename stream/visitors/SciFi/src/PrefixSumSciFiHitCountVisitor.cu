  ...
  argument_manager_t& arguments)
{
  arguments.set_size<dev_prefix_sum_auxiliary_array_4>(
    prefix_sum_scifi_hits_t::aux_array_size(runtime_options.number_of_events * SciFi::Constants::n_mat_groups_and_mats));
}
  ...
  cudaEvent_t& cuda_generic_event)
{
  ...
  state.set_size(runtime_options.number_of_events * SciFi::Constants::n_mat_groups_and_mats);
  ...
  cudaCheck(cudaMemcpyAsync(
    ...
    arguments.offset<dev_scifi_hit_count>() + runtime_options.number_of_events * SciFi::Constants::n_mat_groups_and_mats,
    sizeof(uint),
