...
{
  arguments.set_size<dev_windows_layers>(10 * UT::Constants::n_layers * host_buffers.host_number_of_reconstructed_velo_tracks[0]);
...
{
  state.set_opts(dim3(host_buffers.host_number_of_selected_events[0]), dim3(UT::Constants::n_layers, 128), cuda_stream);
